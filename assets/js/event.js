...
let dem = 1
var sliderList = [
    { url :'url("/assets/images/slider/newy.jpg") top center / cover no-repeat',
      text_title: "New York",
      text_de: "The atmosphere in New York is lorem ipsum."
    },
    { url :'url("/assets/images/slider/chicago.jpg") top center / cover no-repeat',
      text_title: "Chicago",
      text_de: "Thank you, Chicago - A night we won't forget."
    },
    { url :'url("/assets/images/slider/losa.jpg") top center / cover no-repeat',
